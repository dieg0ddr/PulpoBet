  ...
  return (
    <div className="flex-1 w-full lg:w-auto bg-[#100d20] border border-[#2a2745] rounded-xl p-4 md:p-5 flex flex-col justify-center shadow-lg min-w-[320px]">
      <div className="w-full relative overflow-hidden">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 md:gap-4 h-full content-center">
          {masJugadosGames.map((game, idx) => (
...
`;
fs.writeFileSync('src/components/MiniMasJugadosCarousel.tsx', newContent);

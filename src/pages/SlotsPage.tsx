...
export default function SlotsPage({ onPlayGame }: { onPlayGame?: (game: any) => void }) {
  return (
    <>
      <section className="flex flex-col lg:flex-row gap-4 w-full">
        {/* TV Banner */}
        <BannerCarousel customBanners={slotsBanners} hideText={true} containerClassName="relative flex-1 w-full lg:w-auto aspect-[430/265] md:aspect-auto md:min-h-[250px] lg:min-h-0 bg-gradient-to-br border border-[#2a2745] rounded-xl overflow-hidden flex items-center p-4 md:p-8 group cursor-pointer shadow-lg transition-colors duration-500" />

        {/* MÁS JUGADOS Carousel Sidebar */}
        <MiniMasJugadosCarousel onPlayGame={onPlayGame} />
      </section>
